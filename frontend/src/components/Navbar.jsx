  ...
  <section class="relative mx-auto">
    ...
    <nav class="flex justify-between bg-gray-900 text-white w-screen">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <Link to = "/" > <li><a class="hover:text-gray-200" href="#">Create Post</a></li></Link>

        <Link to ="/all" ><li><a class="hover:text-gray-200" href="#">All User Detail</a></li></Link>
         
          
        <Link to ="/ContactUs" ><li><a class="hover:text-gray-200" href="#">Contact Us</a></li></Link>
